...
\begin{frame}{Example with pictures}
	...
	\begin{figure}[ht]
	    \centering
			\only<1>{\includegraphics[width=0.6\textwidth]{figs/Day1.png}}
			\only<2>{\includegraphics[width=0.6\textwidth]{figs/Day2.png}}
			\only<3>{\includegraphics[width=0.6\textwidth]{figs/Day3.png}}
			\only<4>{\includegraphics[width=0.6\textwidth]{figs/Day178.png}}
	\end{figure}
	%
\end{frame} 
